# Padrão visual e de entrega obrigatório para aplicativos web

Esta regra complementa o `AGENTS.md` raiz e vale para todos os projetos atuais ou futuros sob `web/`.
