"""Endpoints de primícia para o módulo document.

Recurso 17: Obrigações Vivas
Gerado automaticamente em 2026-07-26T14:39:59.402823
"""
...
router = APIRouter(tags=["document-primicias"])
FLAG = "primicia.document.living_obligations"
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para document."""
...
async def health_check() -> HealthResponse:
    """Health check do módulo document."""
...
async def get_status() -> StatusResponse:
    """Status geral do módulo document."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para document.
