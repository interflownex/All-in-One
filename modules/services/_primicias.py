"""Endpoints de primícia para o módulo services.

Recurso 9: Contrato de Resultado
Gerado automaticamente em 2026-07-26T14:39:59.419261
"""
...
router = APIRouter(tags=["services-primicias"])
FLAG = "primicia.services.outcome_contract"
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para services."""
...
async def get_status() -> StatusResponse:
    """Status geral do módulo services."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para services.
