"""Endpoints de primícia para o módulo erp.

Recurso 12: Encerramento Contínuo
Gerado automaticamente em 2026-07-26T14:39:59.403210
"""
...
router = APIRouter(tags=["erp-primicias"])
FLAG = "primicia.erp.continuous_close"
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para erp."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para erp.
