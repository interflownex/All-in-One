"""Endpoints de primícia para o módulo bpm.

Recurso 16: Laboratório de Processos
Gerado automaticamente em 2026-07-26T14:39:59.399086
"""
...
router = APIRouter(tags=["bpm-primicias"])
FLAG = "primicia.bpm.process_laboratory"
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para bpm."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para bpm.
