"""Endpoints de primícia para o módulo riders.

Recurso 8: Passaporte de Evidência
Gerado automaticamente em 2026-07-26T14:39:59.416157
"""
...
router = APIRouter(tags=["riders-primicias"])
FLAG = "primicia.riders.evidence_passport"
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para riders."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para riders.
