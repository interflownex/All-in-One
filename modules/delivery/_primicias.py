"""Endpoints de primícia para o módulo delivery.

Recurso 7: Capacidade de Rota
Gerado automaticamente em 2026-07-26T14:39:59.402427
"""
...
router = APIRouter(tags=["delivery-primicias"])
FLAG = "primicia.delivery.route_capacity"
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para delivery."""
...
async def health_check() -> HealthResponse:
    """Health check do módulo delivery."""
...
async def get_status() -> StatusResponse:
    """Status geral do módulo delivery."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para delivery.
