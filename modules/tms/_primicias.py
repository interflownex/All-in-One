"""Endpoints de primícia para o módulo tms.

Recurso 14: Câmbio Cego de Capacidade
Gerado automaticamente em 2026-07-26T14:39:59.421461
"""
...
router = APIRouter(tags=["tms-primicias"])
FLAG = "primicia.tms.blind_capacity_exchange"
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para tms."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para tms.
