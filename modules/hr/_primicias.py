"""Endpoints de primícia para o módulo hr.

Recurso 18: Agendamento de Afinidade Justa
Gerado automaticamente em 2026-07-26T14:39:59.404436
"""
...
router = APIRouter(tags=["hr-primicias"])
FLAG = "primicia.hr.fair_affinity_schedule"
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para hr."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para hr.
