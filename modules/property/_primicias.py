"""Endpoints de primícia para o módulo property.

Recurso 21: Capacidade Compartilhada
Gerado automaticamente em 2026-07-26T14:39:59.407823
"""
...
router = APIRouter(tags=["property-primicias"])
FLAG = "primicia.property.shared_capacity"
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para property."""
...
async def health_check() -> HealthResponse:
    """Health check do módulo property."""
...
async def get_status() -> StatusResponse:
    """Status geral do módulo property."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para property.
