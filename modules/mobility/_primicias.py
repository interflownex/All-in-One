"""Endpoints de primícia para o módulo mobility.

Recurso 10: Rota Intencional Premium
Gerado automaticamente em 2026-07-26T14:39:59.406911
"""
...
router = APIRouter(tags=["mobility-primicias"])
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para mobility."""
...
async def health_check() -> HealthResponse:
    """Health check do módulo mobility."""
...
async def get_status() -> StatusResponse:
    """Status geral do módulo mobility."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para mobility.
