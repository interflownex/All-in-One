"""Endpoints de primícia para o módulo health.

Recurso 19: Cápsula de Continuidade
Gerado automaticamente em 2026-07-26T14:39:59.403918
"""
...
router = APIRouter(tags=["health-primicias"])
FLAG = "primicia.health.continuity_capsule"
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para health."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para health.
