"""Endpoints de primícia para o módulo crm.

Recurso 15: Promessas ao Cliente
Gerado automaticamente em 2026-07-26T14:39:59.400057
"""
...
router = APIRouter(tags=["crm-primicias"])
FLAG = "primicia.crm.customer_promises"
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para crm."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para crm.
