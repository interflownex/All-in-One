"""Endpoints de primícia para o módulo identity.

Recurso 1: Prova de Identidade Mínima
Gerado automaticamente em 2026-07-26T14:39:59.404881
"""
...
router = APIRouter(tags=["identity-primicias"])
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para identity."""
...
async def health_check() -> HealthResponse:
    """Health check do módulo identity."""
...
async def get_status() -> StatusResponse:
    """Status geral do módulo identity."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para identity.
