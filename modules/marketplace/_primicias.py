"""Endpoints de primícia para o módulo marketplace.

Recurso 5: Coligação de Compra Local
Gerado automaticamente em 2026-07-26T14:39:59.406242
"""
...
router = APIRouter(tags=["marketplace-primicias"])
FLAG = "primicia.marketplace.local_buying_coalition"
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para marketplace."""
...
async def get_status() -> StatusResponse:
    """Status geral do módulo marketplace."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para marketplace.
