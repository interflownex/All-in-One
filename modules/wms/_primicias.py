"""Endpoints de primícia para o módulo wms.

Recurso 13: Confiança de Inventário
Gerado automaticamente em 2026-07-26T14:39:59.422632
"""
...
router = APIRouter(tags=["wms-primicias"])
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para wms."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para wms.
