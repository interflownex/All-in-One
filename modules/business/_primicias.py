"""Endpoints de primícia para o módulo business.

Recurso 2: Consórcio Flash
Gerado automaticamente em 2026-07-26T14:39:59.399695
"""
...
router = APIRouter(tags=["business-primicias"])
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para business."""
...
async def health_check() -> HealthResponse:
    """Health check do módulo business."""
...
async def get_status() -> StatusResponse:
    """Status geral do módulo business."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para business.
