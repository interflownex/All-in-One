...
PRESETS: dict[BusinessKind, dict[str, list[str]]] = {
    "physical_store": {
        ...
        "hidden": ["health", "mobility", "tms", "wms", "legal", "property", "ai_core"],
    },
    "ecommerce": {
        "mandatory": ["identity", "business", "permissions"],
        "active": ["marketplace", "finance", "stock", "delivery", "crm"],
        "recommended": ["bi", "document"],
        "hidden": ["health", "mobility", "tms", "legal", "property", "ai_core"],
    },
    "dropshipping": {
        "mandatory": ["identity", "business", "permissions"],
        "active": ["marketplace", "finance", "stock", "crm"],
        "recommended": ["tms", "bi", "document"],
        "hidden": ["health", "mobility", "jobs", "legal", "property", "ai_core"],
    },
    "restaurant": {
        "mandatory": ["identity", "business", "permissions"],
        "active": ["marketplace", "delivery", "finance", "crm"],
        "recommended": ["stock", "bi"],
        "hidden": ["health", "tms", "wms", "jobs", "legal", "property", "ai_core"],
    },
    "services_provider": {
        "mandatory": ["identity", "business", "permissions"],
        "active": ["services", "finance", "crm"],
        "recommended": ["document", "jobs", "bi"],
        "hidden": ["marketplace", "wms", "tms", "legal", "property", "ai_core"],
    },
    "carrier": {
        "mandatory": ["identity", "business", "permissions"],
        "active": ["tms", "finance", "document"],
        "recommended": ["wms", "bi", "hr"],
        "hidden": ["health", "marketplace", "services", "legal", "property", "ai_core"],
    },
    "clinic": {
        "mandatory": ["identity", "business", "permissions"],
        "active": ["health", "document", "finance"],
        "recommended": ["crm", "hr", "bi", "ai_core"],
        "hidden": ["marketplace", "tms", "wms", "legal", "property"],
    },
    "industry": {
        "mandatory": ["identity", "business", "permissions"],
        "active": ["erp", "finance", "wms"],
        "recommended": ["tms", "bpm", "bi", "hr", "ai_core"],
        "hidden": ["health", "mobility", "services", "legal", "property"],
    },
    "office": {
        "mandatory": ["identity", "business", "permissions"],
        "active": ["crm", "finance", "document"],
        "recommended": ["hr", "bi", "bpm", "legal", "property"],
        "hidden": ["wms", "tms", "health", "ai_core"],
    },
    "autonomous": {
        "mandatory": ["identity"],
        "active": ["services", "finance"],
        "recommended": ["document", "crm"],
        "hidden": ["erp", "wms", "tms", "health", "legal", "property", "ai_core"],
    },
    "rider": {
        "mandatory": ["identity"],
        "active": ["riders", "delivery", "finance"],
        "recommended": ["document"],
        "hidden": ["erp", "wms", "health", "crm", "legal", "property", "ai_core"],
    },
    "driver_partner": {
        "mandatory": ["identity"],
        "active": ["riders", "mobility", "finance"],
        "recommended": ["document"],
        "hidden": ["erp", "wms", "health", "marketplace", "legal", "property", "ai_core"],
    },
}
