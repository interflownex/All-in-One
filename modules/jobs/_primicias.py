"""Endpoints de primícia para o módulo jobs.

Recurso 11: Disponibilidade Reversa
Gerado automaticamente em 2026-07-26T14:39:59.405434
"""
...
router = APIRouter(tags=["jobs-primicias"])
FLAG = "primicia.jobs.reverse_availability"
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para jobs."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para jobs.
