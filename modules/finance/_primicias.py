"""Endpoints de primícia para o módulo finance.

Recurso 4: Dinheiro Earmarked
Gerado automaticamente em 2026-07-26T14:39:59.403584
"""
...
router = APIRouter(tags=["finance-primicias"])
FLAG = "primicia.finance.earmarked_money"
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para finance."""
...
async def health_check() -> HealthResponse:
    """Health check do módulo finance."""
...
async def get_status() -> StatusResponse:
    """Status geral do módulo finance."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para finance.
