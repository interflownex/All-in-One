"""Endpoints de primícia para o módulo legal.

Recurso 20: Radar de Impacto
Gerado automaticamente em 2026-07-26T14:39:59.405896
"""
...
router = APIRouter(tags=["legal-primicias"])
FLAG = "primicia.legal.impact_radar"
...
async def get_feature_status() -> FeatureStatusResponse:
    """Retorna status da primícia para legal."""
...
async def create_delegation(request: DelegationRequest) -> DelegationResponse:
    """Cria uma delegação/procuração para legal.
