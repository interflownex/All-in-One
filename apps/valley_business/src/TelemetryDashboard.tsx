    ...
    <div className="glass-card" style={{ gridColumn: "1 / -1" }}>
      ...
      >
        <h3 className="card-title" style={{ margin: 0 }}>
          Monitoramento de Eventos (Outbox)
        </h3>
        <button
      ...
      >
        ...
        >
          <h4 style={{ color: "var(--text-muted)", margin: "0 0 0.5rem 0", fontSize: "0.9rem" }}>
            Fila Pendente
          </h4>
          <p
            style={{
              ...
              margin: 0,
              fontWeight: 600,
              color: metrics?.pending ? "#f1c40f" : "white",
            }}
          >
            {metrics?.pending ?? "-"}
          </p>
        ...
        >
          ...
          <p
            style={{
              ...
              margin: 0,
              fontWeight: 600,
              color: metrics?.due ? "#e74c3c" : "white",
            }}
          >
            {metrics?.due ?? "-"}
          </p>
        ...
        >
          ...
          <p
            style={{
              ...
              margin: 0,
              fontWeight: 600,
              color: metrics?.failed_retryable ? "#e67e22" : "white",
            }}
          >
        ...
        >
          ...
          <p style={{ fontSize: "2rem", margin: 0, fontWeight: 600 }}>
            {metrics?.oldest_pending_age_seconds !== undefined
              ? `${metrics.oldest_pending_age_seconds.toFixed(1)}s`
              : "-"}
          </p>
        </div>
      </div>
