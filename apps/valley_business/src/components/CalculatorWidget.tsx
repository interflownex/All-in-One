...
const CalculatorWidget: React.FC = () => {
  ...
  const CalcButton = ({
    label,
    onClick,
    color = "var(--valley-surface-neutral)",
    wide = false,
  }: any) => (
    <button
      onClick={onClick}
  ...
  return (
    <div
      className="neo-card"
      style={{ maxWidth: "320px", backgroundColor: "var(--valley-surface-purple)" }}
    >
      ...
      >
        <div style={{ fontSize: "0.8rem", color: "var(--valley-lavender)", height: "1rem" }}>
          {equation}
        </div>
        {display}
      </div>
      ...
      <div
        style={{ marginTop: "15px", fontSize: "0.7rem", fontWeight: "bold", textAlign: "center" }}
      >
