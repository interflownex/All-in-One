...
const transactions = [
  {
    ...
    description: "Venda #1092 - Smartphone",
    amount: "R$ 1.200,00",
    type: "credit",
  },
  {
    ...
    description: "Taxa Marketplace Valley",
    amount: "- R$ 24,00",
    type: "debit",
  },
  {
    ...
    description: "Compra de 100 Pepitas",
    amount: "- R$ 10,00",
    type: "debit",
  },
  {
    ...
    description: "Venda #1093 - Capa Protetora",
    amount: "R$ 45,00",
    type: "credit",
  },
];
...
const LedgerTransactionList: React.FC = () => {
  return (
    <div
      className="neo-card"
      style={{ maxWidth: "600px", backgroundColor: "var(--valley-surface-neutral)" }}
    >
      <div
        style={{
          display: "flex",
      ...
      >
        <h3 style={{ margin: 0, fontWeight: 900, color: "var(--valley-deep-purple)" }}>
          EXTRATO (APPEND-ONLY)
        </h3>
        <div
          style={{
            backgroundColor: "var(--valley-cyan)",
            padding: "5px 10px",
        ...
        {transactions.map((tx) => (
          <div
            ...
            style={{
              ...
              backgroundColor:
                tx.type === "credit"
                  ? "var(--valley-surface-blue)"
                  : "var(--valley-surface-purple)",
