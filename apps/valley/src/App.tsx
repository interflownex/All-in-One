...
function App() {
  ...
  const submitCatalogAction = async (
    scheduledAt?: string,
    note?: string,
    ...
    <>
      ...
      >
        ...
        <nav style={{ display: "flex", gap: "12px", alignItems: "center" }}>
          <button
            className="btn-link"
            style={{ color: "#fff", fontWeight: currentView === "consumer" ? "bold" : "normal" }}
          ...
          <button
            className="btn-link"
            style={{ color: "#fff", fontWeight: currentView === "b2b" ? "bold" : "normal" }}
          ...
          <button
            className="btn-link"
            style={{ color: "#fff", fontWeight: currentView === "tracking" ? "bold" : "normal" }}
      ...
      {currentView === "consumer" && (
        <main className="container">
          <section className="hero">
            ...
            <p>
              Produtos, alimentos e servicos organizados de um jeito simples, com todos os modulos
              conectados para teste.
            </p>
            ...
            <div className="business-filters">
              ...
              <label>
                ...
                <select
                  ...
                  onChange={(event) => setSelectedCompanyCategory(event.target.value)}
                >
              ...
              <label>
                ...
                <select
                  ...
                  onChange={(event) => setSelectedBusinessActivity(event.target.value)}
                >
                  ...
                  >
                    ...
                    >
                      {safeMediaUrl(offer.metadata?.image_url) && (
                        <img
                          src={safeMediaUrl(offer.metadata?.image_url)}
                          alt={offer.title}
                          loading="lazy"
                          decoding="async"
                    ...
                    <div className="provider">
                      ...
                      {offer.verified_seller ? " - verificado" : ""}
                    </div>
                    <div className="region">
                      {offer.distance_km != null ? `${offer.distance_km.toFixed(1)} km - ` : ""}
                      {offer.region_label}
                    </div>
                    ...
                    <div className="offer-meta">
                      <span className="price">
                        {offer.price_amount
                          ? `R$ ${Number(offer.price_amount).toFixed(2).replace(".", ",")}`
                          : "Sob orcamento"}
                      </span>
          ...
          <section className="modules-section">
            <div className="section-heading">
              <div>
                ...
                <p>
                  Jornadas prontas para teste com artefatos, simulacoes e ligacoes funcionais ao
                  shell do consumidor.
                </p>
              </div>
            </div>
