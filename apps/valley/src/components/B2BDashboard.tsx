    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: "1rem" }}>
          <button
            style={{
              padding: "0.5rem 1rem",
              background: activeTab === "overview" ? "#3b82f6" : "#e2e8f0",
              color: activeTab === "overview" ? "white" : "#0f172a",
              border: "none",
              borderRadius: "4px",
              cursor: "pointer",
            }}
          ...
          <button
            style={{
              padding: "0.5rem 1rem",
              background: activeTab === "calendar" ? "#3b82f6" : "#e2e8f0",
              color: activeTab === "calendar" ? "white" : "#0f172a",
              border: "none",
              borderRadius: "4px",
              cursor: "pointer",
            }}
      ...
      {activeTab === "overview" && (
        ...
        >
          ...
          >
            <h3 style={{ color: "#64748b", fontSize: "0.875rem", textTransform: "uppercase" }}>
              Pedidos e Conversao
            </h3>
            <p
              style={{ fontSize: "2rem", fontWeight: "bold", color: "#0f172a", margin: "0.5rem 0" }}
            >
              {metrics.orders_completed}
            </p>
            <span style={{ color: "#10b981", fontSize: "0.875rem" }}>
              {metrics.conversion_rate_percent.toFixed(2)}% de conversao
            </span>
          </div>
          ...
          >
            ...
            <p
              style={{ fontSize: "2rem", fontWeight: "bold", color: "#0f172a", margin: "0.5rem 0" }}
            >
              {metrics.support_cases_total}
            </p>
            <span style={{ color: "#f59e0b", fontSize: "0.875rem" }}>
              {metrics.support_cases_open} em aberto
            </span>
          </div>
          ...
          >
            ...
            <p
              style={{ fontSize: "2rem", fontWeight: "bold", color: "#0f172a", margin: "0.5rem 0" }}
            >
              {metrics.crm_records + metrics.bi_records}
            </p>
            <span style={{ color: "#0f172a", fontSize: "0.875rem" }}>
              {metrics.crm_records} CRM | {metrics.bi_records} BI
            </span>
          </div>
