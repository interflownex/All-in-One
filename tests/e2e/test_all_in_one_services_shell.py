...
def test_all_in_one_services_dashboard_and_reservation(page: Page, all_in_one_services_server: str) -> None:
    ...
    expect(page.get_by_role("heading", name="Solar Care")).to_be_visible()
    ...
    expect(page.locator(".provider-card", has_text="Solar Care")).to_be_visible()
    expect(page.locator(".provider-card", has_text="Prime Services")).to_be_visible()
