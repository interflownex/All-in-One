...
TARGET_IMAGES = [
    "ai-core", "api-hub", "bi", "bpm", "business", "crm", "delivery", "document",
    "erp", "finance", "health", "hr", "identity", "jobs", "legal", "marketplace",
    "mobility", "permissions", "property", "riders", "services", "stock", "tms",
    "vision", "wms", "outbox-dispatcher", "retention-worker"
]

def check_images():
    print(f"🔍 Validando {len(TARGET_IMAGES)} imagens no Artifact Registry: {REGISTRY_URL}\n")
    ...
    for img in TARGET_IMAGES:
        ...
        cmd = ["gcloud", "artifacts", "docker", "images", "describe", full_path, "--format=json"]
