...
| `bi` | 61% | Datasets/dashboards modelados, `BiPostgresStore` tipado, dataset CRUD prioritario e primeiro dashboard auditavel aprovado no shell Business | ETL, permissao analitica e datasets reais | Conectar ETL/permissoes analiticas a fontes reais homologadas |
