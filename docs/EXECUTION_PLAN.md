...
- Expandir Playwright E2E por jornada para Riders e Health; as jornadas contratuais locais
...
Proximos passos naturais:
1. Replicar acoes de jornada vivas para Riders e Health.
