...
| --- | ---: | --- | --- | --- |
| `identity` | 87% | Contrato, runtime, PostgreSQL especializado, cadastro/login/KYC/MFA E2E, container healthy e negativas de documento/telefone no registro publico cobertas por testes | KYC/KYB/liveness reais | Homologar provedor KYC/KYB/liveness e repetir evidencias negativas com dados controlados |
