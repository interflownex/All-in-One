...
| Integracoes externas | 39% | Contratos, matriz versionada, adapters sandbox e endpoints administrativos locais existem, incluindo refund sandbox de Finance | Provedores reais dependem de credenciais/homologacao e testes de contrato externos. |
