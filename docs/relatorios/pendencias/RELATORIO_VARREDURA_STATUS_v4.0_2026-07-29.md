# Relatório de Varredura e Status v4.0

**Data e hora:** 29/07/2026 20:30, `America/Sao_Paulo`  
...
| Governança documental | Preservar tarefas e relatórios anteriores | Corrigida no PR | 4 | 100% | concluído | 6 | 6 | 0 |
...
- documentos v3.6 e v3.9 restaurados ao conteúdo da `main`;
- novos registros criados em v4.0;
