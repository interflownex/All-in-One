...
Fonte física versionada com 32 schemas e 167 tabelas. Proprietários são inferidos pelo schema/módulo e precisam de confirmação. Backup, restore, retenção e estado de produção não são comprovados pelas migrations.
...
| SQLite | 4 tabelas / 53 campos | inventário estático; runtime pendente |
| Object storage | 4 stores/referências | inventário estático; buckets e restore pendentes |
| Browser storage | 11 chaves/famílias | inventário estático; comportamento E2E pendente |
