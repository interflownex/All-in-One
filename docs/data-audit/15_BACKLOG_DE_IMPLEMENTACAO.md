...
| 5 | AUD-P1-004 | produto, arquitetura e engenharia | Metadados, API, homologação, segurança, publicação, cobrança, auditoria e testes estão implementados. | autorização RBAC/ABAC, API Hub | implementacao_parcial |
