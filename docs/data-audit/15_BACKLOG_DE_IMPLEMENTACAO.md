...
| 6 | AUD-P1-005 | catálogo, estoque, ERP e fiscal | Unidades, conversões, perfis fiscais, vigência e cálculos possuem migrations, backend, frontend, integração e homologação aprovados. | especialista fiscal, ambiente PostgreSQL, frontend | implementacao_parcial |
