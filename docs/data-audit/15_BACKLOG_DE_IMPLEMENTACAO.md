...
| 5 | AUD-P1-004 | produto, arquitetura e engenharia | Metadados, API, homologação, segurança, publicação, cobrança, auditoria e testes estão implementados. | builder web, PostgreSQL de homologação | implementacao_parcial |
