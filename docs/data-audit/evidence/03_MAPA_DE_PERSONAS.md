...
Estes papéis são criados dinamicamente para gerenciar membros de uma empresa. A lista abaixo representa os papéis _sugeridos_ ou _padrão_ para um novo negócio:
