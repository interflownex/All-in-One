...
| user_id | UUID | False | False | identity.users.id | pessoal | database/postgres/migrations/018_business_catalog_offers.sql:5 |
...
| short_description | TEXT | True | False |  | pessoal | database/postgres/migrations/018_business_catalog_offers.sql:11 |
...
| price_type | VARCHAR(40) | False | False |  | não classificado automaticamente | database/postgres/migrations/018_business_catalog_offers.sql:16 |
| price_amount | NUMERIC(18, 4) | True | False |  | não classificado automaticamente | database/postgres/migrations/018_business_catalog_offers.sql:17 |
...
| location_type | VARCHAR(40) | False | False |  | não classificado automaticamente | database/postgres/migrations/018_business_catalog_offers.sql:19 |
...
| created_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/018_business_catalog_offers.sql:27 |
| updated_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/018_business_catalog_offers.sql:28 |
