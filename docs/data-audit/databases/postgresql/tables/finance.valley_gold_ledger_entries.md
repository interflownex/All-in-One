...
| user_id | UUID | False | False | identity.users.id | pessoal | database/postgres/migrations/015_valley_gold_ledger.sql:5 |
...
| amount_gold_delta | INTEGER | False | False |  | não classificado automaticamente | database/postgres/migrations/015_valley_gold_ledger.sql:8 |
...
| created_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/015_valley_gold_ledger.sql:14 |
