...
| description | TEXT | False | False |  | pessoal | database/postgres/migrations/017_erp_invoice_items.sql:7 |
...
| unit_price_brl | NUMERIC(18, 4) | False | False |  | não classificado automaticamente | database/postgres/migrations/017_erp_invoice_items.sql:9 |
| total_price_brl | NUMERIC(18, 4) | False | False |  | não classificado automaticamente | database/postgres/migrations/017_erp_invoice_items.sql:10 |
| tax_amount_brl | NUMERIC(18, 4) | False | False |  | não classificado automaticamente | database/postgres/migrations/017_erp_invoice_items.sql:11 |
