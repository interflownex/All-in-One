...
| user_id | UUID | True | False | identity.users.id | pessoal | database/postgres/migrations/005_audit_events_api_security.sql:43 |
...
| created_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/005_audit_events_api_security.sql:49 |
