...
| user_id | UUID | False | False | identity.users.id | pessoal | database/postgres/migrations/006_jobs_recruitment_ctps.sql:47 |
...
| employer_name | VARCHAR(240) | False | False |  | pessoal | database/postgres/migrations/006_jobs_recruitment_ctps.sql:53 |
| employer_cnpj | VARCHAR(20) | True | False |  | sensível/restrito | database/postgres/migrations/006_jobs_recruitment_ctps.sql:54 |
...
| user_activity_description | TEXT | True | False |  | pessoal | database/postgres/migrations/006_jobs_recruitment_ctps.sql:58 |
...
| created_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/006_jobs_recruitment_ctps.sql:66 |
| updated_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/006_jobs_recruitment_ctps.sql:67 |
