...
| user_id | UUID | True | False | identity.users.id | pessoal | database/postgres/migrations/005_audit_events_api_security.sql:5 |
| actor_user_id | UUID | True | False | identity.users.id | pessoal | database/postgres/migrations/005_audit_events_api_security.sql:6 |
...
| ip_address | INET | True | False |  | pessoal | database/postgres/migrations/005_audit_events_api_security.sql:14 |
...
| device_fingerprint | TEXT | True | False |  | pessoal | database/postgres/migrations/005_audit_events_api_security.sql:16 |
...
| created_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/005_audit_events_api_security.sql:20 |
