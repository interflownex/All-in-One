...
| user_id | UUID | False | False | identity.users.id | pessoal | database/postgres/migrations/004_enterprise_verticals.sql:21 |
...
| name | VARCHAR(160) | False | False |  | pessoal | database/postgres/migrations/004_enterprise_verticals.sql:23 |
| addressing_rules | JSONB | False | False |  | pessoal | database/postgres/migrations/004_enterprise_verticals.sql:24 |
...
| created_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/004_enterprise_verticals.sql:30 |
| updated_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/004_enterprise_verticals.sql:31 |
