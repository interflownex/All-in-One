...
| user_id | UUID | False | False | identity.users.id | pessoal | database/postgres/migrations/010_api_hub_refinement.sql:26 |
...
| provider_name | VARCHAR(100) | False | False |  | pessoal | database/postgres/migrations/010_api_hub_refinement.sql:29 |
...
| created_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/010_api_hub_refinement.sql:39 |
| updated_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/010_api_hub_refinement.sql:40 |
