...
| user_id | UUID | False | False | identity.users.id | pessoal | database/postgres/migrations/001_identity_and_schemas.sql:116 |
| token_hash | TEXT | False | False |  | sensível/restrito | database/postgres/migrations/001_identity_and_schemas.sql:117 |
| device_fingerprint | TEXT | False | False |  | pessoal | database/postgres/migrations/001_identity_and_schemas.sql:118 |
| ip_address | INET | False | False |  | pessoal | database/postgres/migrations/001_identity_and_schemas.sql:119 |
...
| created_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/001_identity_and_schemas.sql:128 |
| updated_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/001_identity_and_schemas.sql:129 |
