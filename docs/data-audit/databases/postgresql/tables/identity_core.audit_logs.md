...
| actor_user_id | UUID | False | False |  | pessoal | database/postgres/migrations/009_identity_core_refinement.sql:73 |
...
| ip_address | INET | True | False |  | pessoal | database/postgres/migrations/009_identity_core_refinement.sql:79 |
