...
| user_id | UUID | False | False | identity.users.id | pessoal | database/postgres/migrations/001_identity_and_schemas.sql:134 |
...
| reviewer_user_id | UUID | True | False | identity.users.id | pessoal | database/postgres/migrations/001_identity_and_schemas.sql:137 |
...
| created_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/001_identity_and_schemas.sql:144 |
| updated_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/001_identity_and_schemas.sql:145 |
