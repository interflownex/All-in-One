...
| user_id | UUID | False | False | identity.users.id | pessoal | database/postgres/migrations/010_api_hub_refinement.sql:5 |
...
| key_name | VARCHAR(150) | False | False |  | pessoal | database/postgres/migrations/010_api_hub_refinement.sql:8 |
| key_hash | TEXT | False | False |  | não classificado automaticamente | database/postgres/migrations/010_api_hub_refinement.sql:9 |
...
| created_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/010_api_hub_refinement.sql:20 |
| updated_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/010_api_hub_refinement.sql:21 |
