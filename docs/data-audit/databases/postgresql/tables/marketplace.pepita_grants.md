...
| user_id | UUID | False | False | identity.users.id | pessoal | database/postgres/migrations/014_valley_ecosystem.sql:5 |
...
| customer_user_id | UUID | False | False | identity.users.id | pessoal | database/postgres/migrations/014_valley_ecosystem.sql:8 |
...
| created_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/014_valley_ecosystem.sql:16 |
| updated_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/014_valley_ecosystem.sql:17 |
