...
| user_id               | UUID        | False | False | identity.users.id | pseudônimo vinculável            | database/postgres/migrations/002_business_permissions_finance.sql:199 |
| wallet_id             | UUID        | False | False |                   | financeiro confidencial          | database/postgres/migrations/002_business_permissions_finance.sql:200 |
...
| nfc_public_token_hash | TEXT        | True  | False |                   | restrito                         | database/postgres/migrations/002_business_permissions_finance.sql:202 |
...
| created_by            | UUID        | True  | False | identity.users.id | pseudônimo vinculável            | database/postgres/migrations/002_business_permissions_finance.sql:209 |
| updated_by            | UUID        | True  | False | identity.users.id | pseudônimo vinculável            | database/postgres/migrations/002_business_permissions_finance.sql:210 |
