...
| user_id | UUID | True | False | identity.users.id | pessoal | database/postgres/migrations/001_identity_and_schemas.sql:167 |
| cpf_document_hash | TEXT | True | False |  | sensível/restrito | database/postgres/migrations/001_identity_and_schemas.sql:168 |
| face_hash | TEXT | True | False |  | não classificado automaticamente | database/postgres/migrations/001_identity_and_schemas.sql:169 |
| email_hash | TEXT | True | False |  | pessoal | database/postgres/migrations/001_identity_and_schemas.sql:170 |
| device_fingerprint | TEXT | True | False |  | pessoal | database/postgres/migrations/001_identity_and_schemas.sql:171 |
| ip_address | INET | True | False |  | pessoal | database/postgres/migrations/001_identity_and_schemas.sql:172 |
...
| created_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/001_identity_and_schemas.sql:179 |
| updated_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/001_identity_and_schemas.sql:180 |
