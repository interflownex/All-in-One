...
| user_id | UUID | False | False | identity.users.id | pessoal | database/postgres/migrations/001_identity_and_schemas.sql:150 |
...
| ip_address | INET | True | False |  | pessoal | database/postgres/migrations/001_identity_and_schemas.sql:155 |
...
| created_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/001_identity_and_schemas.sql:161 |
| updated_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/001_identity_and_schemas.sql:162 |
