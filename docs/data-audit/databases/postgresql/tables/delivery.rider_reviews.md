...
| user_id | UUID | False | False | identity.users.id | pessoal | database/postgres/migrations/024_riders_delivery_schema_alignment.sql:22 |
...
| reviewer_user_id | UUID | True | False | identity.users.id | pessoal | database/postgres/migrations/024_riders_delivery_schema_alignment.sql:24 |
...
| created_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/024_riders_delivery_schema_alignment.sql:32 |
| updated_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/024_riders_delivery_schema_alignment.sql:33 |
