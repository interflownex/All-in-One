...
| job_name | VARCHAR(120) | False | False |  | pessoal | database/postgres/migrations/016_compliance_retention_jobs.sql:29 |
...
| created_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/016_compliance_retention_jobs.sql:37 |
