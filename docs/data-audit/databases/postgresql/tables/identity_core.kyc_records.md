...
| user_id | UUID | False | False | identity_core.users.id | pessoal | database/postgres/migrations/009_identity_core_refinement.sql:29 |
| biometry_hash | TEXT | False | False |  | não classificado automaticamente | database/postgres/migrations/009_identity_core_refinement.sql:30 |
