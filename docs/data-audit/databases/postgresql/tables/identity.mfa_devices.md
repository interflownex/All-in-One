...
| user_id | UUID | False | False | identity.users.id | pessoal | database/postgres/migrations/001_identity_and_schemas.sql:101 |
...
| secret_reference | TEXT | False | False |  | sensível/restrito | database/postgres/migrations/001_identity_and_schemas.sql:103 |
...
| created_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/001_identity_and_schemas.sql:110 |
| updated_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/001_identity_and_schemas.sql:111 |
