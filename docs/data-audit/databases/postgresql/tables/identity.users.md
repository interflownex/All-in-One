...
| full_name | VARCHAR(200) | False | False |  | pessoal | database/postgres/migrations/001_identity_and_schemas.sql:39 |
| cpf_document | VARCHAR(32) | False | False |  | sensível/restrito | database/postgres/migrations/001_identity_and_schemas.sql:40 |
| birth_date | DATE | False | False |  | pessoal | database/postgres/migrations/001_identity_and_schemas.sql:41 |
| email | CITEXT | False | False |  | pessoal | database/postgres/migrations/001_identity_and_schemas.sql:42 |
| phone_e164 | VARCHAR(20) | False | False |  | pessoal | database/postgres/migrations/001_identity_and_schemas.sql:43 |
| password_hash | TEXT | False | False |  | sensível/restrito | database/postgres/migrations/001_identity_and_schemas.sql:44 |
| face_hash | TEXT | False | False |  | não classificado automaticamente | database/postgres/migrations/001_identity_and_schemas.sql:45 |
...
| default_wallet_id | UUID | True | False |  | não classificado automaticamente | database/postgres/migrations/001_identity_and_schemas.sql:52 |
...
| created_by | UUID | True | False |  | não classificado automaticamente | database/postgres/migrations/001_identity_and_schemas.sql:59 |
| updated_by | UUID | True | False |  | não classificado automaticamente | database/postgres/migrations/001_identity_and_schemas.sql:60 |
