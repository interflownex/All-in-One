...
| user_id | UUID | False | False | identity.users.id | pessoal | database/postgres/migrations/005_audit_events_api_security.sql:73 |
...
| client_name | VARCHAR(150) | False | False |  | pessoal | database/postgres/migrations/005_audit_events_api_security.sql:75 |
...
| secret_reference | TEXT | False | False |  | sensível/restrito | database/postgres/migrations/005_audit_events_api_security.sql:77 |
...
| created_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/005_audit_events_api_security.sql:85 |
| updated_by | UUID | True | False | identity.users.id | não classificado automaticamente | database/postgres/migrations/005_audit_events_api_security.sql:86 |
