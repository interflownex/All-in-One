...
| user_id | UUID | False | False | identity_core.users.id | pessoal | database/postgres/migrations/009_identity_core_refinement.sql:59 |
...
| ip_address | INET | True | False |  | pessoal | database/postgres/migrations/009_identity_core_refinement.sql:62 |
