...
| AUD-P1-006 | P1 | arquitetura modular | Entidades lógicas sem decisão de persistência homônima | Falha de CRUD nos recursos legados restantes. | implementacao_parcial | Cada entidade possui decisão explícita de persistência, ownership e coordenada UI, ou justificativa versionada de ausência. |
