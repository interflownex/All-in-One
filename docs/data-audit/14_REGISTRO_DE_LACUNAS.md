...
| AUD-P1-002 | P1 | frontend e APIs | Bindings frontend-backend não estão integralmente comprovados | Botões mortos, perda de dados e contratos divergentes. | pendente | Cada campo e ação UI aponta para DTO, endpoint, regra, permissão e teste aprovados. |
